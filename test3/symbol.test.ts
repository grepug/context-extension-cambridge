...
describe("test symbol", () => {
    ...
    test("test pronunciations", () => {
        ...
        expect(data.definitionGroups[0].pronunciations[0].url).toEqual("https://dictionary.cambridge.org/media/english-chinese-simplified/uk_pron/u/ukc/ukcyb/ukcyber021.mp3");
