...
describe("test buy", () => {
    ...
    test("test pronunciations", () => {
        ...
        expect(data.definitionGroups[0].pronunciations[0].url).toEqual("https://dictionary.cambridge.org/media/english-chinese-simplified/uk_pron/u/ukb/ukbut/ukbutte013.mp3");
